...
export async function fetchGoogleCalendarCredential() {
  return tenantRequest<GoogleCredentialResponse>("/integrations/google-calendar/");
}

export async function saveGoogleCalendarCredential(input: {
  calendar_id?: string;
