...
class Contact(TenantAwareModel):
    ...
    type = models.CharField(max_length=16, choices=ContactType.choices, default=ContactType.GUEST)
    ...
    class Meta:
        ordering = ["name"]
        constraints = [
            models.UniqueConstraint(fields=["tenant", "email"], name="tenant_unique_contact_email", condition=~models.Q(email="")),
        ]
...
class Lead(TenantAwareModel):
    ...
    stage = models.CharField(max_length=16, choices=LeadStage.choices, default=LeadStage.NEW)
