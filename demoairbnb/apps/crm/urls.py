...
urlpatterns = [
    ...
    path("tenants/<uuid:tenant_id>/crm/contacts/<uuid:contact_id>/", contact_detail, name="contact-detail"),
    path("tenants/<uuid:tenant_id>/crm/leads/", lead_list, name="lead-list"),
    path("tenants/<uuid:tenant_id>/crm/leads/<uuid:lead_id>/", lead_detail, name="lead-detail"),
]
